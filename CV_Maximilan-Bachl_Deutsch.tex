...
\section{Ausbildung}
\cventry{seit 10.2011}{Bachelor-Studium der Informatik}{Technische Universität}{Berlin}{}{Notenschnitt im Moment 1,78}  % arguments 3 to 6 can be left empty
...
\cventry{8.2009}{Praktikum}{OMV}{Wien}{}{Entwicklung eines Mail-Verteiler-Programms und diverse Verwaltungtätigkeiten}
%\newline{}
...
\section{Hobbies}
\cvitem{Sport}{Einradfahren, Fahrräder, Skifahren, Rudern, Krafttraining}
\cvitem{Sonstige}{Programmierung, Lesen, Philosophie}
